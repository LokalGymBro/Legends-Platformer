...
public class ExplodeEnemy : MonoBehaviour
{
    ...
    private bool exploded = false; // Flag to track if the enemy has exploded
    ...
    private void Update()
    {
        // Check if the enemy has already exploded or if the player is too far away
    ...
    {
        // Set the exploded flag to true to prevent multiple explosions
        exploded = true;
